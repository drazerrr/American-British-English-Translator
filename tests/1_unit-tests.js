...
suite('Unit Tests', () => {
    suite("Translate to British English", function() {
        test("Translate Mangoes are my favorite foods. to British English", function(done) {
            assert.equal(
    ...
    suite("Highlight translation", function() {
        test("Highlight translation Mangoes are my favorite fruit. to British English", function(done) {
            assert.equal(
                translator.toBritishEnglish("Mangoes are my favorite fruit.")[1], 'Mangoes are my <span class="highlight">favourite</span> fruit.'
            )
            done();
        });
        test("Highlight translation I ate yogurt for breakfast. to British English", function(done) {
            assert.equal(
                translator.toBritishEnglish("I ate yogurt for breakfast.")[1], 'I ate <span class="highlight">yoghurt</span> for breakfast.'
            )
            done();
        });
        test("Highlight translation We watched the footie match for a while. to British English", function(done) {
            assert.equal(
        ...
        test("Highlight translation Paracetamol takes up to an hour to work. to British English", function(done) {
            assert.equal(
